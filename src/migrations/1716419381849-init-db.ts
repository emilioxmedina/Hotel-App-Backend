...
export class InitDb1716419381849 implements MigrationInterface {
    name = 'InitDb1716419381849'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "payment" ("id" SERIAL NOT NULL, "payment_type" character varying(50) NOT NULL, "amount" double precision NOT NULL, "userId" integer, CONSTRAINT "PK_fcaec7df5adf9cac408c686b2ab" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "rooms" ("id" SERIAL NOT NULL, "room_number" integer NOT NULL, "price" numeric(6,2) NOT NULL, "num_beds" integer NOT NULL, "num_people" integer NOT NULL, "description" character varying NOT NULL, "occupied" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_0368a2d7c215f2d0458a54933f2" PRIMARY KEY ("id"))`);
