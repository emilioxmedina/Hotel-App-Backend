...
export class Init031716500658854 implements MigrationInterface {
    name = 'Init031716500658854'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "reservations" ("id" SERIAL NOT NULL, "init_date" date NOT NULL, "end_date" date NOT NULL, "usersId" integer, "roomsId" integer, "paymentId" integer, CONSTRAINT "REL_f8dbec76216ec5e4ef78cdecbc" UNIQUE ("paymentId"), CONSTRAINT "PK_da95cef71b617ac35dc5bcda243" PRIMARY KEY ("id"))`);
